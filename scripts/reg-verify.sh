...
aba_echo "Checking registry access is working using podman login:"
cmd="podman login --authfile regcreds/pull-secret-mirror.json $reg_url"
aba_echo "Running: $cmd"
$cmd

aba_echo_ok "Success! Valid registry credential file(s) found in mirror/regcreds/ for registry $reg_url"
