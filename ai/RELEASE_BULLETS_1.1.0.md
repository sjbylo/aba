...
- **TUI v2** — Complete interactive UI rewrite with wizard mode, operator browsing, and advanced menu.
...
- **Content-layer catalog refresh** — Detect real operator updates without false re-downloads.
...
- Hardened config editing against metacharacter corruption.
