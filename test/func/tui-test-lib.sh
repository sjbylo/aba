...
# --- Aliases: map legacy TUI_ names (v1) to TUI2_ names (v2) ---
# The old tui/tui-strings.sh used TUI_ prefix; tui-strings2.sh uses TUI2_.
# All test scripts still reference the TUI_ names.
TUI_TITLE_WELCOME="$TUI2_TITLE_WELCOME"
TUI_TITLE_RESUME="${TUI2_TITLE_RESUME:-Existing Configuration Found}"
TUI_TITLE_CHANNEL="$TUI2_TITLE_CHANNEL"
TUI_TITLE_VERSION="$TUI2_TITLE_VERSION"
TUI_TITLE_CONFIRM="${TUI2_TITLE_CONFIRM:-Confirm Selection}"
TUI_TITLE_PULL_SECRET="$TUI2_TITLE_PULL_SECRET"
TUI_TITLE_PULL_SECRET_REQUIRED="${TUI2_TITLE_PULL_SECRET_REQUIRED:-$TUI2_TITLE_PULL_SECRET}"
TUI_TITLE_PULL_SECRET_PASTE="$TUI2_TITLE_PULL_SECRET_PASTE"
TUI_TITLE_PLATFORM="$TUI2_TITLE_PLATFORM"
TUI_TITLE_OPERATORS="$TUI2_TITLE_OPERATORS"
TUI_TITLE_EMPTY_BASKET="${TUI2_TITLE_EMPTY_BASKET:-Empty Basket}"
TUI_TITLE_OPERATOR_SETS="$TUI2_TITLE_OPERATOR_SETS"
TUI_TITLE_SELECT_OPERATORS="${TUI2_TITLE_SELECT_OPERATORS:-$TUI2_TITLE_OPERATORS}"
TUI_TITLE_ACTION_MENU="${TUI2_TITLE_CONNO_MENU:-Partially Disconnected}"
TUI_TITLE_CONFIRM_EXIT="$TUI2_TITLE_CONFIRM_EXIT"
TUI_TITLE_CONFIRM_EXEC="$TUI2_TITLE_CONFIRM_EXEC"
TUI_TITLE_SETTINGS="$TUI2_TITLE_SETTINGS"
TUI_TITLE_ADVANCED="$TUI2_TITLE_ADVANCED"
TUI_TITLE_CREATE_BUNDLE="${TUI2_TITLE_CONNO_BUNDLE:-Create Install Bundle}"
TUI_TITLE_LOCAL_QUAY="${TUI2_TITLE_LOCAL_QUAY:-Local Quay Registry}"
TUI_TITLE_LOCAL_DOCKER="${TUI2_TITLE_LOCAL_DOCKER:-Local Docker Registry}"
TUI_TITLE_ERROR="$TUI2_TITLE_ERROR"
TUI_TITLE_HELP="$TUI2_TITLE_HELP"

# Extra titles not in TUI2 (hardcoded to match dialog strings)
TUI_TITLE_REMOTE_QUAY="${TUI2_TITLE_REMOTE_QUAY:-Remote Quay Registry}"

# Action menu tags
TUI_ACTION_VIEW_IMAGESET="${TUI2_CONNO_TAG_VIEW_ISC:-V}"
TUI_ACTION_RESET_IMAGESET="${TUI2_CONNO_TAG_RESET_ISC:-A}"
TUI_ACTION_CREATE_BUNDLE="${TUI2_CONNO_TAG_BUNDLE:-B}"
TUI_ACTION_SAVE_IMAGES="${TUI2_CONNO_TAG_SAVE:-S}"
TUI_ACTION_LOCAL_REGISTRY="${TUI2_CONNO_TAG_INSTALL_MIRROR:-M}"
TUI_ACTION_REMOTE_REGISTRY="${TUI2_CONNO_TAG_REMOTE_REGISTRY:-R}"
TUI_ACTION_RERUN_WIZARD="${TUI2_CONNO_TAG_RECONFIGURE:-W}"
TUI_ACTION_SETTINGS="${TUI2_CONNO_TAG_SETTINGS:-C}"
TUI_ACTION_ADVANCED="${TUI2_CONNO_TAG_ADVANCED:-A}"

# Plain-text labels for test assertions
TUI_ACTION_TEXT_VIEW_IMAGESET="View"
TUI_ACTION_TEXT_VIEW_IMAGESET_USER="View User"
TUI_ACTION_TEXT_RESET_IMAGESET="Reset"
