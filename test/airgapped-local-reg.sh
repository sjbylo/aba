...
# Example of how to revert to a snapshot and power on a vm
#(
...
touch mirror/.uninstalled   # In this example no reg is installed from external bastion (this host)
...
#ssh $(whoami)@$bastion2 -- "make -C aba clean"
