...
test-cmd -h $reg_ssh_user@$bastion2 -m "If cluster up, stopping cluster" ". <(make -sC $subdir/aba/standard shell) && . <(make -sC $subdir/aba/standard login) && yes|make -sC $subdir/aba/standard shutdown || true"
